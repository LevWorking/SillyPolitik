...
public class Dialogue : MonoBehaviour
{
    ...
    public Image_Switch TalkingTarget1;
    public Image_Switch TalkingTarget2;
    ...
    if (index < lines.Length - 1) 
        {
            ...
            if (isConversation)
            {
                ...
                //Switch the image that is talking to the other one.
                if (TalkingTarget1.switching_is_active) 
                {
                    TalkingTarget1.switching_is_active = false;
                    TalkingTarget2.switching_is_active = true;
                }
                else
                {
                    TalkingTarget1.switching_is_active = true;  
                    TalkingTarget2.switching_is_active = false;
                }
            }
